...
$(function(){
    $(document).ready(function(){
      ...
      $.get("http://192.168.0.120:8080/finalproject/user/downloaded", {
      ...
      for(var i=0;i<exps.length;i++){
        ...
        $.each(downloads, function (index, item) {
          ...
          //alert("fuck");
          //循环获取数据
          var username = downloads[index].username;
          ...
          for(var i=0;i<load_num;i++){
              if(resources[i].resourceid == resourceid){
                  ...
                  picaddr = "http://192.168.0.120:8080/finalproject/" + resources[i].picaddr;
